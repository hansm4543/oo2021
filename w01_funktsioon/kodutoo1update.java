...
public class kodutoo{   
    ...
    */
    ...
    public static void main(String[] args){
        ...
        //CHECKI kas relv on listis kui jahg siis mine programmiga edasi, muidu küsi kas uuesti või lõpeta programm.
        System.out.println("----------------------------------------");
        if(list.contains(relv)){
            System.out.println("Relv leitud");
        }else{
            System.out.println("Relv ei olnud listis!");
